...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "1304367020:AAHJszK87fR2JQQKj9nS8jEmHg6QqMwEmAs")
    # The Telegram API things
    APP_ID = int(os.environ.get("APP_ID", 1667813))
    API_HASH = os.environ.get("API_HASH", "1f6921c27bf6cd01aba471a14ff33bcb")
    OWNER_ID = int(os.environ.get("OWNER_ID", 1327934109))
    ...
    DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "AiTorrentWare_Bot")
